...
#ifndef EXAMPLES_SDN_WISE_CONFIGURE_H_
#define EXAMPLES_SDN_WISE_CONFIGURE_H_
...
#define CNF_ID_CNT_BEACON_MAX		2		//r&w
#define CNF_ID_CNT_REPORT_MAX		3		//r&w
#define CNF_ID_CNT_UPDTABLE_MAX		4		//r&w
#define CNF_ID_CNT_SKEEP_MAX		5		//r&w		??? -
#define CNF_ID_TTL_MAX				6		//r&w
#define CNF_ID_RSSI_MIN				7		//r&w

#define CNF_ADD_ACCEPTED			8		//w
#define CNF_REMOVE_ACCEPTED			9		//w
#define CNF_LIST_ACCEPTED			10		//r *

#define CNF_ADD_RULE				11		//w			?
#define CNF_REMOVE_RULE				12		//w			?
#define CNF_REMOVE_RULE_INDEX		13		//w
#define CNF_GET_RULE_INDEX			14		//r *

#define CNF_RESET					15		//w
#define CNF_ADD_FUNCTION			16		//w			???
#define CNF_REMOVE_FUNCTION			17		//w			???
/*************************************************************************/
...
function_root * new_function_root(uint8_t id_h, uint8_t id_l, uint8_t total_elements){
	...
	fr->total_bytes = 0;
	fr->root = NULL;
	printf("CONFIGURE - new function root - id=%d.%d\n", fr->id_h, fr->id_l);
	return fr;
}
/*************************************************************************/
...
void function_root_add_element(function_root *fr, uint8_t position, uint8_t *array, uint8_t len_array){
	...
	*/
	...
	printf("CONFIGURE - function root add element\n");
}
/*************************************************************************/
void function_root_remove_all (function_root *fr){
	...
	free(fr);
	printf("CONFIGURE - function root remove all\n");
}
/*************************************************************************/
void function_root_compose_packet(function_root *fr){
	...
	cfs_close(fd_file);
	//printArray(packet, fr->total_bytes);
	printf("CONFIGURE - function root compose packet\n");
}
/*************************************************************************/
...
/*************************************************************************/
#endif /* EXAMPLES_SDN_WISE_CONFIGURE_H_ */
